...
def cnn_model_cifar10(logits=False, input_ph=None, img_rows=32, img_cols=32,
              channels=3, nb_filters=32, nb_classes=10):
    import keras
...
def main(argv=None):
    tutorial(nb_epochs=FLAGS.nb_epochs,
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string('filename', 'cifar10.ckpt', 'Checkpoint filename.')
